...
Для запуска сайта вам понадобится [Python](https://python.org/) третьей версии.

Скачайте код с GitHub, затем следуйте инструкции ниже.
...
После этих процедур, вам необходимо установить пакетные зависимости:

```sh
pip install -r requirements.txt
```

Отлично, осталось запустить сервер:
